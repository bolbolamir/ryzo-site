          ...
          <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-lg lg:flex-shrink-0">
            ...
            >
              ...
              <button
                ...
                className="text-sm font-semibold leading-6 text-foreground inline-flex items-center gap-x-2 hover:text-primary transition-colors"
              >
        ...
        <AnimateOnScroll animation="fadeIn" delay={0.3}>
          ...
          >
            <div className="relative">
              ...
              <div className="relative">
                <img
                  src="https://cdn.shopify.com/app-store/listing_images/13c3194ffbb0fa55c6500b556c4b5e1b/desktop_screenshot/CMnW97n56IkDEAE=.png?height=900&width=1600 1x, https://cdn.shopify.com/app-store/listing_images/13c3194ffbb0fa55c6500b556c4b5e1b/desktop_screenshot/CMnW97n56IkDEAE=.png?height=1800&width=3200 2x"
                ...
                {/* Floating elements */}
                <motion.div
                  className="absolute -top-6 -right-6 bg-card p-4 rounded-lg shadow-lg flex items-center gap-x-3"
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ delay: 1, duration: 0.5 }}
                >
                  <Upload className="h-6 w-6 text-pink-500" />
                  <span className="font-medium text-foreground">Image Search</span>
                </motion.div>

                <motion.div
                  className="absolute -bottom-6 -left-6 bg-card p-4 rounded-lg shadow-lg flex items-center gap-x-3"
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ delay: 1.2, duration: 0.5 }}
                >
                  <Search className="h-6 w-6 text-purple-500" />
                  <span className="font-medium text-foreground">Smart Suggestions</span>
                </motion.div>
              </div>
            </div>
          </motion.div>
